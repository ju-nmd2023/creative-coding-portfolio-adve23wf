...
//Code of color inspired by: https://youtu.be/1-QXuR-XX_s?si=x77IwdVIY3K-Xtym
...
class Lines {
  ...
  checkBorders() {
    if (this.position.x < 600) {
      this.position.x = 990;
      this.lastPosition.x = 990;
    } else if (this.position.x > 990) {
      this.position.x = 600;
      this.lastPosition.x = 600;
    }
  ...
  draw() {
    ...
    let r = map(this.position.x, 0, 500, 50, 255);
    let g = map(this.position.y, 0, 300, 255, 50);
    let b = map(this.position.x, 0, 500, 255, 50);
